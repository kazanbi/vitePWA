...
class B {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), g = h ? await D(
...
se([{"revision":null,"url":"assets/index-4sK4E3Wk.css"},{"revision":null,"url":"assets/index-rhiV0tWN.js"},{"revision":"dbb6898b90cb84856f416ee5ec2291f1","url":"index.html"},{"revision":"1872c500de691dce40960bb85481de07","url":"registerSW.js"},{"revision":"76c738f1d4de06acfad438335d61af72","url":"favicon.ico"},{"revision":"491fdb68a6bc31c495c29c179879fb88","url":"apple-touch-icon.png"},{"revision":"19c78286560cd506884ec3065f357151","url":"manifest.webmanifest"}] || []);
...
self.addEventListener("push", (a) => {
  ...
  if (a.data) {
    const e = a.data.json();
    console.log(a.data), self.registration.showNotification(e.title, {
      body: e.message,
      tag: e.tag,
      icon: e.icon
    });
...
self.addEventListener("notificationclick", (a) => {
  a.waitUntil(self.clients.openWindow(a.notification.tag)), a.notification.close();
});
